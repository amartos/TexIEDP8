...
\begin{graybox}
    ...
    \image{Légende de l'image}{0.3}{Firefox_Developer_Edition_75.0b9_LibriVox.png}{fig:myimage}
...
\screenshot{Légende de la capture}{}{Firefox_Developer_Edition_75.0b9_LibriVox.png}{fig:screenshot}
\screenshot{Légende de la capture}{0.2}{Firefox_Developer_Edition_75.0b9_LibriVox.png}{fig:screenshotreduced}
